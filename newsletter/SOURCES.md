...
The harvest step sweeps these every morning. Tier 1 is checked daily without fail;
Tier 2 is rotated (roughly half each day); Wildcard is a deliberate 3QD-style serendipity
slot — one item per issue from *outside* this list is encouraged.

Sources earn promotion/demotion based on the feedback log in PREFERENCES.md.
An item's *author* matters as much as its outlet — individual thinkers are first-class sources.
...
| Source | URL | Notes |
|---|---|---|
| Import AI — Jack Clark | https://importai.substack.com | policy + capabilities, weekly |
| Interconnects — Nathan Lambert | https://www.interconnects.ai | open models, RLHF, labs |
| Don't Worry About the Vase — Zvi | https://thezvi.substack.com | exhaustive AI weekly roundups |
| Simon Willison | https://simonwillison.net | practical LLM engineering, daily |
| Anthropic research/news | https://www.anthropic.com/news | lab announcements |
| Google DeepMind blog | https://deepmind.google/discover/blog | lab announcements |
| OpenAI news | https://openai.com/news | lab announcements |
| Epoch AI | https://epoch.ai/blog | compute trends, forecasting data |

### Tier 2 (rotating)
| Source | URL | Notes |
|---|---|---|
| AI Snake Oil — Narayanan & Kapoor | https://www.aisnakeoil.com | hype deflation |
| Alignment Forum | https://www.alignmentforum.org | safety research |
| Chip Huyen | https://huyenchip.com/blog | ML systems |
| Sebastian Raschka | https://magazine.sebastianraschka.com | model architecture explainers |
| arXiv cs.AI / cs.LG standouts | https://arxiv.org/list/cs.AI/recent | only genuinely notable papers |
| Hugging Face blog | https://huggingface.co/blog | open-source ecosystem |
...
| Source | URL | Notes |
|---|---|---|
| Stratechery — Ben Thompson | https://stratechery.com | free weekly articles |
| The Diff — Byrne Hobart | https://www.thediff.co | finance × tech |
| Not Boring — Packy McCormick | https://www.notboring.co | techno-optimist strategy |
| Money Stuff — Matt Levine | https://www.bloomberg.com/opinion/authors/ARbTQlRLRjE/matthew-s-levine | via free newsletter mirror |

### Geopolitics & grand strategy — Tier 1
| Source | URL | Notes |
|---|---|---|
| Foreign Affairs | https://www.foreignaffairs.com | 1–2 free/month; excerpt carefully |
| War on the Rocks | https://warontherocks.com | defense & statecraft |
| ChinaTalk — Jordan Schneider | https://www.chinatalk.media | US-China tech competition |
| CSIS / Brookings commentary | https://www.csis.org/analysis | chips, AI governance |

### Decision-making & mental models — Tier 2
| Source | URL | Notes |
|---|---|---|
| Michael Mauboussin | https://www.michaelmauboussin.com/writing | papers, timeless slot staple |
...
| Source | URL | Notes |
|---|---|---|
| Paul Graham essays | https://paulgraham.com/articles.html | timeless slot staple |
| Henrik Karlsson | https://www.henrikkarlsson.xyz | agency, career as search |
| David Perell | https://perell.com/writing | leverage, writing |
| 80,000 Hours articles | https://80000hours.org/all-articles | career impact in an AI world |
...
| Asterisk Magazine | https://asteriskmag.com | quantified futurism |
...
## Pillar 4 — Podcasts (why-listen blurbs)

| Show | Feed/URL | Beat |
|---|---|---|
| Dwarkesh Podcast | https://www.dwarkesh.com | AI, history, big ideas |
| Conversations with Tyler | https://conversationswithtyler.com | polymath interviews |
| EconTalk | https://www.econtalk.org | economics & ideas |
| Invest Like the Best | https://joincolossus.com/episodes | strategy & investing |
| Acquired | https://www.acquired.fm | business case studies |
| Latent Space | https://www.latent.space | AI engineering |
| Hard Fork | https://www.nytimes.com/column/hard-fork | tech news, lighter |
...
One item per issue may come from anywhere — 3QD itself, Marginal Revolution links, LRB/NYRB,
a YouTube lecture, a 15-year-old blog post — provided it clears the "would Jad forward this
