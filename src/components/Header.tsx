          ...
          {!loading && (
            user ? (
              <div className="flex items-center gap-2">
                <Button variant="ghost" size="sm" onClick={() => navigate("/mission-fit")} className="gap-1.5 text-muted-foreground">
                  <Compass className="h-4 w-4" /> <span className="hidden sm:inline">Mission Fit</span>
                </Button>
